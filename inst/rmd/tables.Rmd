...
tab3b <- tab3a_prov %>% 
  ...
  ungroup(.) %>% 
  select(PERFORMINGPROVIDER, sum_spine, sum_pectus, SPECIALTY, PROVIDER_BIRTH_YEAR, p_race, p_hisp, YEAR_GRADUATED, max_proc)

```

```{r tab3b_out, results="asis"}

knitr::kable(tab3b, col.names = c("Physician ID Number", "Count of Spine PXs", "Count of Pectus PXs", "Physician Specialty", "Physician Birth Year", "Physician Year Graduated", "Physician Race", "Physician Ethnicity", "Total Volume"))

...
rx_tab <- data.frame(avg_age = unlist(lapply(list_tab4f, 
                                             function(x) mean(as.numeric(tab4f2$AGE[tab4f2$ProcedureType == x[[1]][[1]] & tab4f2$GENERIC_MED_NAME == x[[1]][[2]]), na.rm = T))))

rx_tab2 <- data.frame(med_age = unlist(lapply(list_tab4f, 
                                              function(x) median(as.numeric(tab4f2[tab4f2$ProcedureType == x[[1]][[1]] & tab4f2$GENERIC_MED_NAME == x[[1]][[2]],
                                                                                  "AGE"]), na.rm = T))))

tab4f2 <- bind_cols(tab4f_vals, rx_tab)
tab4f3 <- bind_cols(tab4f2, rx_tab2) 

mean(as.numeric(tab4f2$AGE[tab4f2$Procedure_Type == list_tab4f[[3]][[1]] & tab4f2$GENERIC_MED_NAME == list_tab4f[[3]][[2]]]), na.rm = T)

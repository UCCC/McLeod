...
tab4_test <- as.data.frame(table(tab4a2$ProcedureType, tab4a2$GENERIC_MED_NAME))

list_tab4 <- split(tab2_test[, c(1,2)], seq(nrow(tab2_test[, c(1,2)])))
...
tab2a3 <- bind_cols(tab4_test, rx_tab)
tab2a4 <- bind_cols(tab2a3, rx_tab2) %>% 

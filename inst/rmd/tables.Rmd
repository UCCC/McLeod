...
tab4_test2 <- as.data.frame(table(tab4a2_2$ProcedureType, tab4a2_2$px_date, tab4a2_2$PERSON_ID, tab4a2_2$GENERIC_MED_NAME, tab4a2_2$RX_DAYS_SUPPLY))
...
tab4b_test <- as.data.frame(table(tab4a2_2$ProcedureType, tab4a2_2$AGE, tab4a2_2$PERSON_ID, tab4a2_2$GENERIC_MED_NAME, tab4a2_2$RX_DAYS_SUPPLY))

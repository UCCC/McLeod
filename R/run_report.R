...
#' @param uid A character vector.  This is the username used to access the VDW
#' @param pwd A character vector.  This is the password matching the above username to access the VDW
